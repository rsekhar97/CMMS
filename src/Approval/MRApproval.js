...
const MRApproval = ({navigation,route}) => {
  ...
  const _goBack = () => {
    ...
    const[emp_det_mr_limit, setemp_det_mr_limit]= React.useState("")
    const[dft_mst_mtr_closed_loop, setdft_mst_mtr_closed_loop]= React.useState("")
    const[dft_mst_mtr_approval_type, setdft_mst_mtr_approval_type]= React.useState("")
  ...
  const get_mr_approval_dropdown =(async ()=>{
    ...
    setspinner(true);
    var dft_mst_mtr_approval_type,emp_det_mr_approver,emp_det_mr_limit,dft_mst_mtr_closed_loop;
    ...
    try{
      ...
      if (response.data.status === 'SUCCESS') 
      {
        for (let i = 0; i < response.data.data.length; ++i){
          dft_mst_mtr_closed_loop = response.data.data[i].dft_mst_mtr_closed_loop
          setdft_mst_mtr_closed_loop(response.data.data[i].dft_mst_mtr_closed_loop)

          if(response.data.data[i].dft_mst_mtr_closed_loop == '0'){
          ...
          if(response.data.data[i].dft_mst_mtr_approval_type == 'R'){

            dft_mst_mtr_approval_type = 'my_level';
            setdft_mst_mtr_approval_type(dft_mst_mtr_approval_type)
            ...
            dft_mst_mtr_approval_type = 'my_limit';
            setdft_mst_mtr_approval_type(dft_mst_mtr_approval_type)
            if(response.data.data[i].dft_mst_mtr_closed_loop == '0'){
        ...
        for (let i = 0; i < response.data.data1.length; ++i){
          ...
          emp_det_mr_approver = response.data.data1[i].emp_det_mr_approver
          emp_det_mr_limit = response.data.data1[i].emp_det_mr_limit

          setemp_det_mr_limit(response.data.data1[i].emp_det_mr_limit);
        }
    
        //setspinner(false);
        get_mr_approval_list(dft_mst_mtr_approval_type,emp_det_mr_limit,dft_mst_mtr_closed_loop)
      }else{
          setspinner(false);
  ...
  const get_mr_approval_list =(async (dft_mst_mtr_approval_type,emp_det_mr_limit,dft_mst_mtr_closed_loop)=>{

    console.log("dft_mst_mtr_approval_type: "+dft_mst_mtr_approval_type)
    console.log("emp_det_mr_limit: "+emp_det_mr_limit)
    console.log("dft_mst_mtr_closed_loop: "+dft_mst_mtr_closed_loop)
  ...
  //   var dft_mst_mtr_approval_type,emp_det_mr_approver,emp_det_mr_limit ;
    ...
    try{
      ...
      console.log("JSON DATA : " + `${BaseUrl}/get_mr_approval_list.php?site_cd=${Site_cd}&type=${dft_mst_mtr_approval_type}&EmpID=${EmpID}&emp_det_mr_limit=${emp_det_mr_limit}&loop=${dft_mst_mtr_closed_loop}`)

      const response = await axios.get(`${BaseUrl}/get_mr_approval_list.php?site_cd=${Site_cd}&type=${dft_mst_mtr_approval_type}&EmpID=${EmpID}&emp_det_mr_limit=${emp_det_mr_limit}&loop=${dft_mst_mtr_closed_loop}`);
  ...
  const ItemView = ({ item }) => {
    ...
    return (
      ...
      <TouchableOpacity onPress={() => getItem(item)}>
        <View style={styles.item}>
          <View style={{ flexDirection: 'row', marginTop:5 }}>
            ...
            <Text style={{color: '#05375a', fontSize: 12, }}>{item.mtr_mst_mr_status}</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row', marginTop:5 }}>
              ...
              <Text style={{flex: 1,color: '#05375a', fontSize: 12, marginLeft:10 }}>{item.mtr_mst_wo_no}</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row', marginTop:5 }}>
              ...
              <Text style={{flex: 1,color: '#05375a', fontSize: 12, marginLeft:10 }}>{item.mtr_mst_assetno}</Text>
          </View>
          <View style={{ alignItems: 'center',flexDirection: 'row', marginTop:5 }}>
              ...
              <Text style={{flex: 1,color: '#05375a', fontSize: 12, marginLeft:10 }}>{'MR Status '+item.Approval_Status}</Text>
          </View>
          ...
          <View style={{ alignItems: 'center',flexDirection: 'row', marginTop:5 }}>
              ...
              <Text style={{flex: 1,color: '#05375a', fontSize: 12, marginLeft:10 }}>{'Total Cost '+item.mtr_mst_tot_cost}</Text>
          </View>
          ...
          <View style={{ alignItems: 'center',flexDirection: 'row', marginTop:5 }}>
              ...
              <Text style={{flex: 1,color: '#05375a', fontSize: 12, marginLeft:10 }}>{item.mtr_mst_requester}</Text>
          </View>
          ...
          <View style={{ alignItems: 'center',flexDirection: 'row', marginTop:5 }}>
              ...
              <Text style={{flex: 1,color: '#05375a', fontSize: 12, marginLeft:10 }}>{'Required Date '+reqdate}</Text>
          </View>
        </View>
      </TouchableOpacity>
      ...
      //       <Text style={{color:'#2962FF',fontSize: 13,backgroundColor:'#D6EAF8',padding:5, fontWeight: 'bold'}} > {item.mtr_mst_mtr_no}</Text>
      //       <Text style={{fontSize: 13,color:'#000'}} >{item.mtr_mst_mr_status}</Text>
      //     </View>

      //     <View style={{flexDirection:"row",marginTop:10}}>
      //       <View style={{width:'40%'}}>
      //           <Text placeholder="Test" style={{color:'#2962FF',fontWeight: 'bold',justifyContent: 'flex-start'}} >Work Order No :</Text>
      //       </View>
      //       <View style={{flex:1}}>
      //           <Text placeholder="Test" style={{justifyContent: 'flex-start',color:'#000'}} >{item.mtr_mst_wo_no}</Text>
      //       </View>
      //     </View>
      ...
      //       </View>
      //       <View style={{flex:1}}>
      //           <Text placeholder="Test" style={{justifyContent: 'flex-start',color:'#000'}} >{item.mtr_mst_assetno}</Text>
      //       </View>
      //     </View>

      //     <View style={{flexDirection:"row",marginTop:5}}>
      //       <View style={{width:'40%'}}>
      //           <Text placeholder="Test" style={{color:'#2962FF',fontWeight: 'bold',justifyContent: 'flex-start'}} >MR Status :</Text>
      //       </View>
      //       <View style={{flex:1}}>
      //           <Text placeholder="Test" style={{justifyContent: 'flex-start',color:'#000'}} >{item.Approval_Status}</Text>
      //       </View>
      //     </View>
      ...
      //       </View>
      //       <View style={{flex:1}}>
      //           <Text placeholder="Test" style={{justifyContent: 'flex-start',color:'#000'}} >{item.mtr_mst_tot_cost}</Text>
      //       </View>
      //     </View>
  ...
  const getItem = (item) => {
   ...
   // console.log(item.audit_date.date)

   var aduitdate = moment(item.audit_date.date).format('yyyy-MM-DD HH:mm:ss')
                     
    navigation.navigate('MRApprovalDetails',{

      Screenname:route.params.Screenname,

      RowID:item.RowID,
      Closed_loop:dft_mst_mtr_closed_loop,
      Approval_type:dft_mst_mtr_approval_type,
      mr_limit:emp_det_mr_limit,
      Mr_tot_cost:item.mtr_mst_tot_cost,
      Audit_date:aduitdate,
      mr_no:item.mtr_mst_mtr_no,
      cur_app_level:item.mtr_mst_cur_app_level,
      app_level:item.mtr_mst_app_level,
      mst_costcenter:item.mtr_mst_costcenter,
  ...
  const Button_select_list =async (selected_value)=>{
    ...
    if(selected_value == "MyLevel"){
      ...
      setdft_mst_mtr_approval_type('my_level')
      get_mr_approval_list('my_level',emp_det_mr_limit,dft_mst_mtr_closed_loop)
      ...
      setFilteredDataSource('')
      setdft_mst_mtr_approval_type('my_limit')
      get_mr_approval_list('my_limit',emp_det_mr_limit,dft_mst_mtr_closed_loop)
      ...
      if(Visible){
        ...
        setFilteredDataSource('')
        setdft_mst_mtr_approval_type('all_level')
        get_mr_approval_list('all_level',emp_det_mr_limit,dft_mst_mtr_closed_loop)
    ...
    if ( e.data) {
      ...
      const newData = MRList.filter(function (item) {
        //const itemData = item.ast_mst_asset_no ? item.ast_mst_asset_no.toUpperCase() : ''.toUpperCase();
          ...
          ,${item.mtr_mst_assetno.toUpperCase()}`
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <View style={styles.view_3}> 
          <Text style={{color:'#F4D03F', fontSize: 15,fontWeight: "bold",flex: 1,textAlign: 'center',alignItems:'center',justifyContent:'center',fontWeight: 'bold',}}>{MyLevel}</Text>
          <Text style={{color:'#8BC34A', fontSize: 15,fontWeight: "bold",flex: 1,textAlign: 'center',alignItems:'center',justifyContent:'center',fontWeight: 'bold',}}>{MyLimit}</Text>
          <Text style={{color:'#FF0000', fontSize: 15,fontWeight: "bold",flex: 1,textAlign: 'center',alignItems:'center',justifyContent:'center',fontWeight: 'bold',}}>{AnyLevel}</Text>
      </View>
