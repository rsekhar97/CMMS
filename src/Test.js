...
const Test = ({ navigation,route }) => {
  ...
  const [EMP_modalVisible, setEMP_modalVisible] = React.useState(false);
   const [wko_mst, setwko_mst] = React.useState({
  ...
  const ItemView = ({item}) => {
    ...
    //   }
    // } else {
    //   let Org_Date = moment(item.wko_mst_org_date.date).format(
    //     'yyyy-MM-DD HH:mm',
    //   );
    //   //console.log(Org_Date)
    //   if (Org_Date === '1900-01-01 00:00') {
    ...
    return (
      <TouchableOpacity onPress={() => getItem(item)} > 
        ...
        <View style={[styles.item,{borderRightWidth:8,borderRightColor:color_sts}]}>
        ...
        <View style={{ flex: 1,flexDirection: 'row'}}>
          ...
          <View style={{ width: '35%'}}>
            ...
            <View style={{height:'100%',borderTopLeftRadius:10,borderBottomLeftRadius:10, alignItems: 'center',justifyContent: 'center',}}>

             {
               ...
               link === '0' &&
               <Image source={require('../images/camera_logo2.jpeg')} style={{width: '70%', height: '60%',borderTopLeftRadius:10,borderBottomLeftRadius:10,}} />
             }
            </View> 
          ...
          <View style={{ flex: 1,margin:10 }}>
            ...
            <View style={{ flexDirection: 'row',marginTop:5 }}>
              <MaterialCommunityIcons
               ...
               <Text style={{ color: '#05375a', fontSize: 12, marginLeft:10 }}>{item.wko_mst_assetno}</Text>
            </View>
            ...
            <View style={{flexDirection: 'row',marginTop:5 }}>
              <MaterialCommunityIcons
               ...
               <Text style={{ color: '#05375a', fontSize: 12, marginLeft:10 }}>{item.wko_mst_work_area +' / '+item.wko_mst_asset_location+' / '+item.wko_mst_asset_level}</Text>
            </View>
            ...
            <View style={{ alignItems: 'center',flexDirection: 'row',marginTop:5 }}>
              <MaterialCommunityIcons
               ...
               <Text style={{ color: '#05375a', fontSize: 12, marginLeft:10 }}>{orgdate}</Text>
            </View>
          ...
          {/* <View style={{flexDirection: 'row', marginTop: 10}}>
            <View style={{width: '30%'}}>
              <Text placeholder="Test" style={{ color: '#05375a', fontWeight: 'bold', justifyContent: 'flex-start',fontSize: 11,}}>Description :</Text>
            </View>
            <View style={{flex: 1}}>
              <Text placeholder="Test" style={{justifyContent: 'flex-start', color: '#5D6D7E',fontSize: 11}}>{item.wko_mst_descs.trim()}</Text>
            </View>
          </View>
          ...
          <View style={{flexDirection: 'row', marginTop: 5}}>
            <View style={{width: '30%'}}>
              <Text placeholder="Test" style={{ color: '#05375a', fontWeight: 'bold', justifyContent: 'flex-start',fontSize: 11,}}>Asset No :</Text>
            </View>
            <View style={{flex: 1}}>
              <Text placeholder="Test" style={{justifyContent: 'flex-start', color: '#5D6D7E',fontSize: 11}}>{item.wko_mst_assetno} </Text>
            </View>
          ...
          <View style={{flexDirection: 'row', marginTop: 5}}>
            <View style={{width: '30%'}}>
              <Text placeholder="Test" style={{ color: '#05375a', fontWeight: 'bold', justifyContent: 'flex-start',fontSize: 11,}}>Asset Desc :</Text>
            </View>
            <View style={{flex: 1}}>
              <Text placeholder="Test" style={{justifyContent: 'flex-start', color: '#5D6D7E',fontSize: 11}}>{item.ast_mst_asset_shortdesc}
              </Text>
            </View>
          </View>
          ...
          <View style={{ flex: 1, justifyContent: 'space-between', flexDirection: 'row'}}>
            <View >
              <Text style={{color: '#05375a', fontSize: 12, fontWeight: 'bold',}}></Text>
            </View>
            <Text style={{fontSize: 10, fontWeight: 'bold', color: color_sts}}>{item.wko_mst_status}</Text>
          ...
          {/* <View style={{flexDirection: 'row', marginTop: 5}}>
            ...
            <Pressable>
              <View style={{ alignItems: 'center',flexDirection: 'row', }}>
                ...
                <Text style={{ color: '#05375a', fontSize: 12, fontWeight: 'bold', marginLeft:10}}>WO Edit</Text>
              </View>
            </Pressable>


            <View style={{  width: 2, backgroundColor: '#C8C8C8', }} />
            ...
            <View style={{ alignItems: 'center',flexDirection: 'row', }}>
              ...
              <Text style={{ color: '#05375a', fontSize: 12, fontWeight: 'bold',marginLeft:10 }}>WO Info</Text>
            </View>
  ...
  const viewitem =(item)=>{
    ...
    console.log(item.wko_mst_wo_no)
    setwko_mst({...wko_mst,wko_mst_wo_no:item.wko_mst_wo_no})
    setEMP_modalVisible(true);
        ...
        <View style={styles.model_cardview}>
          <View style={{flex: 1,margin: 20, backgroundColor: '#FFFFFF'}}>
            <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: '#0096FF', height: 50, }}>
              <Text style={{ flex: 1, fontSize: 15, justifyContent: 'center', color: '#fff', margin: 5, textAlign: 'center', fontWeight: 'bold', }}> Work order info </Text>
              <Ionicons
                name="close"
                color="#ffffffff"
                size={25}
              ...
              <View style={{backgroundColor: '#fff' }}>
                <View style={{flexDirection: 'row', margin:5}}>
                  <View style={{width:'50%'}}>
                      <View style={{flex:1,flexDirection:'row',alignItems:'center'}}>
                        ...
                        <Text placeholder="Test" style={{ color: '#000', fontWeight: 'bold', justifyContent: 'flex-start',fontSize:13}}>Work order No:</Text>
                      </View>
                    
                  </View>
                  <View style={{flex: 1,justifyContent: 'center',}}>
                    <Text placeholder="Test" style={{justifyContent: 'flex-start', color: '#000',fontSize:13}}>{wko_mst.wko_mst_wo_no} </Text>
                  </View>
                </View>
                ...
                <View style={{flexDirection: 'row', margin:5}}>
                  <View style={{width:'50%'}}>
                      <View style={{flex:1,flexDirection:'row',alignItems:'center'}}>
                        <Feather name="box" color="#2C3E50" size={20} style={{marginRight:8, marginTop:4}}/>
                        <Text placeholder="Test" style={{ color: '#000', fontWeight: 'bold', justifyContent: 'flex-start',fontSize:13}}>Origination Date:</Text>
                      </View>
                ...
                <View style={{flexDirection: 'row', margin:5}}>
                  <View style={{width:'50%'}}>
                      <View style={{flex:1,flexDirection:'row',alignItems:'center'}}>
                        <Feather name="box" color="#2C3E50" size={20} style={{marginRight:8, marginTop:4}}/>
                        <Text placeholder="Test" style={{ color: '#000', fontWeight: 'bold', justifyContent: 'flex-start',fontSize:13}}>Requester Name:</Text>
                      </View>
                ...
                <View style={{flexDirection: 'row', margin:5}}>
                  <View style={{width:'50%'}}>
                      <View style={{flex:1,flexDirection:'row',alignItems:'center'}}>
                        <Feather name="box" color="#2C3E50" size={20} style={{marginRight:8, marginTop:4}}/>
                        <Text placeholder="Test" style={{ color: '#000', fontWeight: 'bold', justifyContent: 'flex-start',fontSize:13}}>Asset Description:</Text>
                      </View>
                ...
                <View style={{flexDirection: 'row', margin:5}}>
                  <View style={{width:'50%'}}>
                      <View style={{flex:1,flexDirection:'row',alignItems:'center'}}>
                        <Feather name="box" color="#2C3E50" size={20} style={{marginRight:8, marginTop:4}}/>
                        <Text placeholder="Test" style={{ color: '#000', fontWeight: 'bold', justifyContent: 'flex-start',fontSize:13}}>Work Area:</Text>
                      </View>
                ...
                <View style={{flexDirection: 'row', margin:5}}>
                  <View style={{width:'50%'}}>
                      <View style={{flex:1,flexDirection:'row',alignItems:'center'}}>
                        <Feather name="box" color="#2C3E50" size={20} style={{marginRight:8, marginTop:4}}/>
                        <Text placeholder="Test" style={{ color: '#000', fontWeight: 'bold', justifyContent: 'flex-start',fontSize:13}}>Asset Location:</Text>
                      </View>
                ...
                <View style={{flexDirection: 'row', margin:5}}>
                  <View style={{width:'50%'}}>
                      <View style={{flex:1,flexDirection:'row',alignItems:'center'}}>
                        <Feather name="box" color="#2C3E50" size={20} style={{marginRight:8, marginTop:4}}/>
                        <Text placeholder="Test" style={{ color: '#000', fontWeight: 'bold', justifyContent: 'flex-start',fontSize:13}}>Asset Level:</Text>
                      </View>
                ...
                <View style={{flexDirection: 'row', margin:5}}>
                  <View style={{width:'50%'}}>
                      <View style={{flex:1,flexDirection:'row',alignItems:'center'}}>
                        <Feather name="box" color="#2C3E50" size={20} style={{marginRight:8, marginTop:4}}/>
                        <Text placeholder="Test" style={{ color: '#000', fontWeight: 'bold', justifyContent: 'flex-start',fontSize:13}}>Work Group:</Text>
                      </View>
                ...
                <View style={{flexDirection: 'row', margin:5}}>
                  <View style={{width:'50%'}}>
                      <View style={{flex:1,flexDirection:'row',alignItems:'center'}}>
                        <Feather name="box" color="#2C3E50" size={20} style={{marginRight:8, marginTop:4}}/>
                        <Text placeholder="Test" style={{ color: '#000', fontWeight: 'bold', justifyContent: 'flex-start',fontSize:13}}>Assign to:</Text>
                      </View>
                ...
                <View style={{flexDirection: 'row', margin:5}}>
                  <View style={{width:'50%'}}>
                      <View style={{flex:1,flexDirection:'row',alignItems:'center'}}>
                        <Feather name="box" color="#2C3E50" size={20} style={{marginRight:8, marginTop:4}}/>
                        <Text placeholder="Test" style={{ color: '#000', fontWeight: 'bold', justifyContent: 'flex-start',fontSize:13}}>Assign Date:</Text>
                      </View>
                ...
                <View style={{flexDirection: 'row', margin:5}}>
                  <View style={{width:'50%'}}>
                      <View style={{flex:1,flexDirection:'row',alignItems:'center'}}>
                        <Feather name="box" color="#2C3E50" size={20} style={{marginRight:8, marginTop:4}}/>
                        <Text placeholder="Test" style={{ color: '#000', fontWeight: 'bold', justifyContent: 'flex-start',fontSize:13}}>Due Date:</Text>
                      </View>
